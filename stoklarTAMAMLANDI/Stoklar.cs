...
namespace pansiyonotomasyonu
{
    public partial class Stoklar : Form
    {
        ...
        {
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("insert into Fatura (Elektrik,Su,Internet) VALUES ( @elektrik , @su , @internet  )", baglanti);
            komut2.Parameters.AddWithValue("@elektrik", txtelektrik.Text);
            komut2.Parameters.AddWithValue("@su", txtsu.Text);
            komut2.Parameters.AddWithValue("@internet", txtint.Text);
